...
The work for this case study is not aimed at producing something for a boss. It is aimed at practicing examining missingness and joins. Therefore, providing and displaying code is expected. Raw tibble output is acceptable (meaning, you do not need to use `kable()` to make tables).
